...
public class LoginActivity /*extends PlusBaseActivity*/ extends Activity {//implements LoaderCallbacks<Cursor>
    ...
    protected  MobileServiceTable<USERS1> mUser;
   ...
   /* private boolean supportsGooglePlayServices() {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                final MobileServiceList<USERS1> result = mUser.where().top(100).execute().get();
                for (USERS1 credential : result) {
                    email1 = credential.getEmail();
                    password1 = credential.getPassWord();
                    if (email1.equals(mEmail)) {
                        // Account exists, return true if the password matches.
                        //userid = credential.UserID;
                        return password1.equals(mPassword);
                    }
                }
